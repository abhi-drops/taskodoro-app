...
- M3 animation utilities (sheets, dialogs, list items): `m3-sheet`, `m3-dialog`, `m3-center-sheet`, `m3-list-item`, `m3-fade-in`, etc. `m3-center-sheet` is for centered desktop modals — slides up from below (translateY 40px → 0, scale 0.96 → 1) with expressive spring easing.
